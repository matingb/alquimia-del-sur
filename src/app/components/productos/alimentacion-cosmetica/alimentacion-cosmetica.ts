...
@Component({
  selector: 'app-alimentacion-cosmetica',
  templateUrl: './alimentacion-cosmetica.component.html',
  styleUrls: ['./alimentacion-cometica.component.scss'],
  animations: [
    trigger('slideInOut', [
...
export class AlimentacionCosmeticaComponent implements OnInit {
